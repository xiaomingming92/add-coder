...
- **主导 AI**: {AI 助手标识}
- **关联文档**:
  - ADD Route: `.claude/plans/{YYYY-MM}/{DD}/{需求域名}-{核心内容}-add-route-v{版本}.md`
  - Handoff: `.claude/plans/{YYYY-MM}/{DD}/{需求域名}-{核心内容}-handoff-v{版本}.md`
  - Review: `.claude/reviews/{需求域名}-review-v{版本}.md`
- **ADD-7 审计策略**:
