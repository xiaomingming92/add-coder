...
- 具体实现细节以对应 `.claude/specs/{spec-name}/spec.md`、`tasks.md`、`checklist.md` 为准。
...
4. read ".claude/specs/{spec-name}/spec.md"
5. read ".claude/specs/{spec-name}/tasks.md"
6. read ".claude/specs/{spec-name}/checklist.md"
```
...
- `.claude/specs/{spec-name}/checklist.md`
...
3. 读本轮对应 .claude/specs/{spec-name}/spec.md（含其中的「文档先行三步闭环」章节，按 spec 的指示更新架构文档）
4. 读本轮对应 .claude/specs/{spec-name}/tasks.md
5. 读本轮对应 .claude/specs/{spec-name}/checklist.md
