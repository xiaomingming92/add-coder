...
- 本 handoff 是新对话的入口索引。具体实现细节以 `.vscode/specs/add-coder-add-coder-npm-package/spec.md`、`tasks.md`、`checklist.md` 为准。
...
3. read ".vscode/specs/add-coder-add-coder-npm-package/spec.md"
4. read ".vscode/specs/add-coder-add-coder-npm-package/tasks.md"（第1轮）
5. read ".vscode/specs/add-coder-add-coder-npm-package/checklist.md"（一、二、四）
```
...
- `.vscode/specs/add-coder-add-coder-npm-package/spec.md`
- `.vscode/specs/add-coder-add-coder-npm-package/tasks.md`（第1轮）
- `.vscode/specs/add-coder-add-coder-npm-package/checklist.md`（一、二、四）
...
| `.vscode/settings.json` / `.vscode/mcp.json` | 修改 | 硬编码路径 → 占位符 |
| `.vscode/hooks/` 下 14 个 `.sh` + `lib/` | 修改 | 项目名提取逻辑 |
...
2. read ".vscode/specs/add-coder-add-coder-npm-package/tasks.md"（第2轮）
```
...
- `.vscode/specs/add-coder-add-coder-npm-package/tasks.md`（第2轮）
...
| `templates/.vscode/hooks/` | `templates/adapters/qoder/hooks/` | 迁移 |
| `templates/.vscode/settings.json` | `templates/adapters/qoder/settings.json` | 迁移 |
| `templates/.vscode/mcp.json` | `templates/adapters/qoder/mcp.json` | 迁移 |
...
```
1. query_audit_logs({ planKeyword: "add-coder-npm-package" })
2. read ".vscode/specs/add-coder-add-coder-npm-package/tasks.md"（第3轮）
3. read ".vscode/specs/add-coder-add-coder-npm-package/checklist.md"（三）
```
...
- `.vscode/specs/add-coder-add-coder-npm-package/tasks.md`（第3轮）
- `.vscode/specs/add-coder-add-coder-npm-package/checklist.md`（三）
...
- `npx add-coder init --adapter qoder` 生成 `.vscode/` 目录 ✅
...
```
1. query_audit_logs({ planKeyword: "add-coder-npm-package" })
2. read ".vscode/specs/add-coder-add-coder-npm-package/tasks.md"（第4轮）
3. read ".vscode/specs/add-coder-add-coder-npm-package/checklist.md"（五）
```
...
- `.vscode/specs/add-coder-add-coder-npm-package/tasks.md`（第4轮）
- `.vscode/specs/add-coder-add-coder-npm-package/checklist.md`（五）
...
```
1. query_audit_logs({ planKeyword: "add-coder-npm-package" })
2. read ".vscode/specs/add-coder-add-coder-npm-package/tasks.md"（第5轮）
3. read ".vscode/specs/add-coder-add-coder-npm-package/checklist.md"（五、六、八）
```
...
- `.vscode/specs/add-coder-add-coder-npm-package/tasks.md`（第5轮）
- `.vscode/specs/add-coder-add-coder-npm-package/checklist.md`（五、六、八）
...
```
1. query_audit_logs({ planKeyword: "add-coder-npm-package" })
2. read ".vscode/specs/add-coder-add-coder-npm-package/tasks.md"（第6轮）
3. read ".vscode/specs/add-coder-add-coder-npm-package/checklist.md"（七）
...
- `.vscode/specs/add-coder-add-coder-npm-package/spec.md`（Requirement: CaijueHub 裁决层）
- `.vscode/specs/add-coder-add-coder-npm-package/tasks.md`（第6轮）
- `.vscode/specs/add-coder-add-coder-npm-package/checklist.md`（七）
...
| 模板部署策略 | 仅 `.add/` | `.vscode/` `.claude/` 同时部署 core 内容 | IDE 只认自身 magic path，需三者各自完整 |
...
| Review v2 回流 | 无 | `.vscode/reviews/add-coder-add-coder-npm-package-review-v2.md` | 代码实现评审：2 条 P0（spawnSync catch 失能、ask 重复定义）在 Plan §4.8 回流，P0-1 已补充至 Task 1.0 验收项 |
...
上游 [第1轮~第N-1轮] 已完成。
先读 .vscode/plans/2026-07/08/add-coder-add-coder-npm-package-handoff-v1.md 的 <第N轮> 章节。

## 启动步骤（按顺序）

1. 执行 session-init SKILL
2. 执行 add-paradigm SKILL
3. 读 .vscode/specs/add-coder-add-coder-npm-package/spec.md
4. 读 .vscode/specs/add-coder-add-coder-npm-package/tasks.md（第N轮）
5. 读 .vscode/specs/add-coder-add-coder-npm-package/checklist.md
