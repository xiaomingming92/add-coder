...
>
> **绑定**：Plan: `.vscode/plans/2026-07/08/add-coder-add-coder-npm-package-plan-v1.md` · Spec: `.vscode/specs/add-coder-add-coder-npm-package/spec.md` ✅ · Tasks: `.vscode/specs/add-coder-add-coder-npm-package/tasks.md` ✅ · Handoff: `.vscode/plans/2026-07/08/add-coder-add-coder-npm-package-handoff-v1.md` ✅
...
**输入**：
- 上游 Review：`.vscode/reviews/add-coder-add-coder-npm-package-review-v1.md` ✅
- 上游 Review v2：`.vscode/reviews/add-coder-add-coder-npm-package-review-v2.md` ✅ — 代码实现评审
- Plan 文档：`.vscode/plans/2026-07/08/add-coder-add-coder-npm-package-plan-v1.md` ✅
...
| 6b | 3 | 三目录部署（core→.add/.vscode/.claude） | `src/core/renderer.ts`、`src/cli/commands/init.ts`、adapter renderers | `record_dev_operation` (MODIFY) | — | 第3轮 Task 2 | ⬜ |
