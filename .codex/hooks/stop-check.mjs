// templates/adapters/codex/hooks/stop-check.ts
...
var CodexStopRouter = class extends StopRouter {
  /** ② Q3: systemMessage JSON（codex 协议——approval/tasks 字段，bash 原文逐字） */
  emitQ3(plan, approval, tasks) {
