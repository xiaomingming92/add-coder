...
| 文档类型 | 命名规则 | 示例 | 存放位置 |
|---------|---------|------|---------|
| 开发任务（specs 三元组） | `项目名-任务名/` | `add-coder-response-strategy/` | `.codex/specs/` |
| review 文件 | `项目名-任务名-round{N}-review.md` | `add-coder-response-strategy-round2-review.md` | `.codex/reviews/` |
| handoff 文件 | `项目名-需求名-handoff.md` | `add-coder-co-agent-handoff.md` | `.codex/plans/{YYYY-MM}/{DD}/`（与 Plan 同目录） |
