# add-coder-npm-package-add-route-v1
...
>
> **绑定**：Plan: `.add/plans/2026-07/08/add-coder-npm-package-plan-v1.md` · Spec: `.add/specs/add-coder-npm-package/spec.md` ✅ · Tasks: `.add/specs/add-coder-npm-package/tasks.md` ✅ · Handoff: `.add/plans/2026-07/08/add-coder-npm-package-handoff-v1.md` ✅
...
**输入**：
- 上游 Review：`.add/reviews/add-coder-npm-package-review-v1.md` ✅
- 上游 Review v2：`.add/reviews/add-coder-npm-package-review-v2.md` ✅ — 代码实现评审
- Plan 文档：`.add/plans/2026-07/08/add-coder-npm-package-plan-v1.md` ✅
...
| 6b | 3 | 三目录部署（core→.add/.add/.claude） | `src/core/renderer.ts`、`src/cli/commands/init.ts`、adapter renderers | `record_dev_operation` (MODIFY) | — | 第3轮 Task 2 | ⬜ |
