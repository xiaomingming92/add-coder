...
// templates/adapters/trae/hooks/pre-tool-use.ts
var TraePreToolUseGuard = class extends PreToolUseGuard {
...
var guard2 = new TraePreToolUseGuard(PROJECT_DIR, MAGIC_DIR);
if (command !== "") {
