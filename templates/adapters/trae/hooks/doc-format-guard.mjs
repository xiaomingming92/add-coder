// templates/adapters/trae/hooks/doc-format-guard.ts
...
// templates/adapters/trae/hooks/doc-format-guard.ts
var TraeDocFormatGuard = class extends DocFormatGuard {
...
var guard = new TraeDocFormatGuard(PROJECT_DIR, MAGIC_DIR);
var raw = "";
try {
