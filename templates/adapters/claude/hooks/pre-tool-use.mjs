...
function queryPlanStatus() {
  const magicDir2 = process.env.MAGIC_DIR;
  if (!magicDir2) {
    return {
...
var PreToolUseGuard = class {
  ...
  planStatus;
  adapterName;
  constructor(projectDir, magicDir2, adapterName = "core") {
    this.projectDir = projectDir;
    this.magicDir = magicDir2;
...
// templates/adapters/claude/hooks/pre-tool-use.ts
process.env.PROJECT_DIR = resolveClaudeProjectDir();
var PROJECT_DIR = process.env.PROJECT_DIR;
var magicDir = tryResolveMagicDir();
if (magicDir && !process.env.MAGIC_DIR) {
  process.env.MAGIC_DIR = magicDir;
}
var MAGIC_DIR = process.env.MAGIC_DIR || "";
var ClaudePreToolUseGuard = class extends PreToolUseGuard {
  constructor(projectDir, magicDir2) {
    super(projectDir, magicDir2, "claude");
  }
...
var guard2 = new ClaudePreToolUseGuard(PROJECT_DIR, MAGIC_DIR);
if (toolName === "Bash") {
