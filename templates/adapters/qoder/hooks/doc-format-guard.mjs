// templates/adapters/qoder/hooks/doc-format-guard.ts
...
// templates/adapters/qoder/hooks/doc-format-guard.ts
var QoderDocFormatGuard = class extends DocFormatGuard {
...
var guard = new QoderDocFormatGuard(PROJECT_DIR, MAGIC_DIR);
var raw = "";
try {
