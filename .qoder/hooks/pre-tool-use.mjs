...
// templates/adapters/qoder/hooks/pre-tool-use.ts
injectProjectDir();
...
var QoderPreToolUseGuard = class extends PreToolUseGuard {
...
`);
    ...
    writeHookEvent("pre-tool-use", "ask", `${toolName2} ${filePath}`, `HITL \u672A tongyi: ${tongyiMarker}`, this.planKeyword, this.planStatus);
    return 2;
  }
...
var guard2 = new QoderPreToolUseGuard(PROJECT_DIR, MAGIC_DIR);
if (toolName === "Bash") {
